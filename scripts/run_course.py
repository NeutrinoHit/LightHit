...
<p>Одиннадцать исполняемых ноутбуков. Базовые примеры используют открытые
искусственные параметры; событийная часть может читать локальный G4-файл,
но не встраивает его данные в учебные артефакты.</p>
